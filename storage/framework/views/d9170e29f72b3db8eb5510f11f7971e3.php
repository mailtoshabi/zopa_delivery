        ...
        <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                <td>
                    ...
                    <?php endif; ?>
                    <a href="<?php echo e(route('kitchen.customers.edit',encrypt($customer->id))); ?>" class=""><?php echo e($customer->name); ?></a>
                    </td>
                    ...
                    <td>
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li><a class="dropdown-item" href="<?php echo e(route('kitchen.customers.edit',encrypt($customer->id))); ?>"><i class="mdi mdi-pencil font-size-16 text-success me-1"></i> Edit</a></li>
                                
                                    <li><a class="dropdown-item" onclick="return confirm('Are you sure to make the change?')" href="<?php echo e(route('kitchen.customers.changeStatus',encrypt($customer->id))); ?>"><?php echo $customer->is_approved?'<i class="fas fa-power-off font-size-16 text-danger me-1"></i> Suspend':'<i class="fas fa-circle-notch font-size-16 text-primary me-1"></i> Activate'; ?></a></li>
                                <li><a class="dropdown-item" href="<?php echo e(route('kitchen.customers.show',encrypt($customer->id))); ?>"><i class="fa fa-eye font-size-16 text-success me-1"></i> Details</a></li>
                            </ul>
                        </div>
                    </td>
            </tr>
...
<?php /**PATH C:\xampp\htdocs\zopa_delivery\resources\views\kitchen\customers\table.blade.php ENDPATH**/ ?>