    ...
    document.addEventListener('DOMContentLoaded', function () {
        document.querySelectorAll('.reply-form').forEach(form => {
            form.addEventListener('submit', function (e) {
                ...
                fetch(`/kitchen./feedbacks/${feedbackId}/reply-ajax`, {
                    method: 'POST',
                    headers: {
...
<?php echo $__env->make('kitchen..layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\zopa_delivery\resources\views\kitchen\feedbacks\index.blade.php ENDPATH**/ ?>