<div class="col-md-12 p-4 lh-lg">
            ...
            <p><small><i>Note: Add-on purchases cannot be canceled after <?php echo e(App\Helpers\FileHelper::convertTo12Hour(Utility::CUTOFF_TIME)); ?> on the day of delivery.</i></small></p>
            ...
            <ul>
                ...
                <li>Today's leave must be applied <strong>before <?php echo e(App\Helpers\FileHelper::convertTo12Hour(Utility::CUTOFF_TIME)); ?></strong>.</li>
            ...
            <ul>
                ...
                <li><strong>Missed the cutoff time?</strong> Orders, leaves, and add-on changes can't be made after <strong><?php echo e(App\Helpers\FileHelper::convertTo12Hour(Utility::CUTOFF_TIME)); ?></strong>.</li>
            </ul>
...
<?php /**PATH C:\xampp\htdocs\zopa_delivery\resources\views/partials/how_to_use_content.blade.php ENDPATH**/ ?>