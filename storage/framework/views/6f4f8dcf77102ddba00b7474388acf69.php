...
unset($__errorArgs, $__bag); ?>
                    ...
                    <?php if(empty($customer->kitchen) || empty($customer->location_name)): ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-sm-12 d-none mb-3 position-relative" id="kitchenContainer">
                            ...
                            <select id="kitchen_id" name="kitchen_id" class="form-control">
                                <option value="<?php echo e(isset($customer)&&(!empty($customer->kitchen))?$customer->kitchen->id : ''); ?>" selected><?php echo e(isset($customer)&&(!empty($customer->kitchen))? $customer->kitchen->name : ''); ?></option>
                            </select>
