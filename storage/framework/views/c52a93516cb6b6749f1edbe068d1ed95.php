...
<div class="row">
    ...
    <ul class="nav nav-tabs">
        <li class="nav-item">
          <a class="nav-link <?php if($is_active==Utility::ITEM_ACTIVE): ?> active <?php endif; ?>" <?php if($is_active==Utility::ITEM_ACTIVE): ?>aria-current="page"<?php endif; ?> href="<?php echo e(route('kitchen.orders.index','status='.encrypt(Utility::ITEM_ACTIVE))); ?>">All</a>
        </li>
        <li class="nav-item">
          <a class="nav-link <?php if($is_active==Utility::ITEM_INACTIVE): ?> active <?php endif; ?>" <?php if($is_active==Utility::ITEM_INACTIVE): ?>aria-current="page"<?php endif; ?> href="<?php echo e(route('kitchen.orders.index','status='.encrypt(Utility::ITEM_INACTIVE))); ?>">Pending <span class="badge rounded-pill bg-soft-danger text-danger float-end"><?php echo e($count_new); ?></span></a>
        </li>
        <li class="nav-item">
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-end">
                                                            <?php if($customer_order->status == Utility::ITEM_INACTIVE): ?>
                                                                <li>
                                                                <a onclick="return confirm('Are you sure to Activate & Mark as Paid?')" class="dropdown-item" href="<?php echo e(route('kitchen.orders.activate',encrypt($customer_order->id))); ?>">
...
<?php echo $__env->make('kitchen.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\zopa_delivery\resources\views\kitchen\customer_order\index_.blade.php ENDPATH**/ ?>