                            ...
                            <?php if($mealtype !=1): ?>
                                <form method="GET" class="row g-3 mb-3">
                                    ...
                                    <div class="col-auto">
                                        ...
                                        <a href="<?php echo e(route('admin.daily_meals.index')); ?>" class="btn btn-outline-secondary btn-sm">Reset</a>
                                    </div>
                                </form>
                            <?php endif; ?>
                            <table class="table align-middle dt-responsive nowrap" style="width: 100%;">
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $dailyMeals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $meal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td><?php echo e($meal->customer->name ?? 'N/A'); ?>

                                                <br><small>Kitchen: <?php echo e($meal->customer->kitchen->display_name); ?></small>
                                            </td>
...
<?php if($mealtype ==1): ?>
    ...
    <div class="modal fade" id="generateMealModal" tabindex="-1" aria-labelledby="generateMealModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form action="<?php echo e(route('admin.daily_meals.generate')); ?>" method="POST" onsubmit="return confirm('Are you sure to generate daily meals for selected kitchen?')">
                <?php echo csrf_field(); ?>
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="kitchen_id" id="kitchen_id" class="form-select" required>
                                ...
                                <?php $__currentLoopData = $kitchens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kitchen): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($kitchen->id); ?>"><?php echo e($kitchen->display_name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                    </div>
...
<div class="modal fade" id="exportModal" tabindex="-1" aria-labelledby="exportModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <form method="GET" action="<?php echo e(route('admin.daily_meals.export')); ?>" onsubmit="return confirm('Are you sure to generate excel of daily meals for selected kitchen?')">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <select name="kitchen_id" id="kitchen_id" class="form-select" required>
                            <option value="">-- Select Kitchen --</option>
                            <?php $__currentLoopData = $kitchens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kitchen): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e(encrypt($kitchen->id)); ?>"><?php echo e($kitchen->display_name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" name="date" id="date" class="form-control" value="<?php echo e(request('date', now()->toDateString())); ?>">
                    </div>
                </div>
