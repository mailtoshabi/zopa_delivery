                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li>
                                                        <a class="dropdown-item" href="<?php echo e(route('kitchen.customers.addons.toggleWalletStatus', encrypt($wallet->id))); ?>">
...
document.getElementById('bulk-status-toggle').addEventListener('click', function () {
    ...
    fetch("<?php echo e(route('kitchen.customers.addons.bulkToggle')); ?>", {
        method: 'POST',
        headers: {
...
<?php echo $__env->make('kitchen.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\zopa_delivery\resources\views\kitchen\wallets\addons.blade.php ENDPATH**/ ?>