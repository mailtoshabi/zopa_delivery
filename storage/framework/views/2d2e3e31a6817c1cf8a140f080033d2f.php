                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="tab-content mt-3" id="customerTabsContent">
                                <div class="tab-pane fade show active" id="individuals" role="tabpanel">
                                    <?php echo $__env->make('kitchen.customers.table', ['customers' => $individuals], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                </div>
                                <div class="tab-pane fade" id="institutions" role="tabpanel">
                                    <?php echo $__env->make('kitchen.customers.table', ['customers' => $institutions], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                </div>
                            </div>
...
<?php echo $__env->make('kitchen.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\zopa_delivery\resources\views\kitchen\customers\index.blade.php ENDPATH**/ ?>