                            ...
                            <?php if($mealtype ==1): ?>
                                <div class="col-md-8 text-end">
                                    <div class="d-inline-block me-2">
                                        <form action="<?php echo e(route('kitchen.daily_meals.mark.all.delivered')); ?>" method="POST" onsubmit="return confirm('Are you sure to mark all as delivered?')">
                                            <?php echo csrf_field(); ?>
                                    ...
                                    <div class="d-inline-block me-2">
                                        <form action="<?php echo e(route('kitchen.daily_meals.undo.delivered')); ?>" method="POST" class="d-inline-block" onsubmit="return confirm('Are you sure to undo all delivered meals for today?')">
                                            <?php echo csrf_field(); ?>
                                    ...
                                    <div class="d-inline-block">
                                        <form action="<?php echo e(route('kitchen.daily_meals.generate')); ?>" method="POST" onsubmit="return confirm('Are you sure to generate daily meals?')">
                                            <?php echo csrf_field(); ?>
                                            <button type="submit" class="btn btn-primary btn-sm">
                                                <i class="mdi mdi-sync"></i> Generate Daily Meal IND
                                            </button>
                                        </form>
                                    </div>
                            ...
                            <?php if($mealtype !=1): ?>
                                <form method="GET" class="row g-3 mb-3">
                                    ...
                                    <div class="col-auto">
                                        ...
                                        <a href="<?php echo e(route('kitchen.daily_meals.index')); ?>" class="btn btn-outline-secondary btn-sm">Reset</a>
                                    </div>
                                </form>
                            <?php endif; ?>
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $dailyMeals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $meal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            ...
                                            <td><?php echo e($meal->walletGroup->name ?? '-'); ?></td>
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-end">
                                                            ...
                                                            <?php if($meal->status && $meal->date->lte(\Carbon\Carbon::today())): ?>
                                                                ...
                                                                <?php else: ?>
                                                                    ...
                                                                    <li>
                                                                        <form action="<?php echo e(route('kitchen.daily_meals.changeDelivery', encrypt($meal->id))); ?>" method="POST" onsubmit="return confirm('Mark as Delivered?')">
                                                                            <?php echo csrf_field(); ?>
...
<?php $__currentLoopData = $dailyMeals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $meal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="modal fade" id="undeliverModal<?php echo e($meal->id); ?>" tabindex="-1" aria-labelledby="undeliverModalLabel<?php echo e($meal->id); ?>" aria-hidden="true">
        <div class="modal-dialog">
            <form method="POST" action="<?php echo e(route('kitchen.daily_meals.changeDelivery', encrypt($meal->id))); ?>">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('kitchen.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\zopa_delivery\resources\views\kitchen\daily_meals\index.blade.php ENDPATH**/ ?>