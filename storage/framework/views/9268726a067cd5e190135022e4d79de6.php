    ...
    <div class="navbar-header">
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="<?php echo e(route('kitchen.dashboard')); ?>" class="logo logo-dark">
                    <span class="logo-sm">
                ...
                <a href="<?php echo e(route('kitchen.dashboard')); ?>" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="<?php echo e(URL::asset('assets/images/logo-sm.svg')); ?>" alt="" height="30">
                    </span>
                    <span class="logo-lg">
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                <button type="submit" onclick="goLink('#')" class="btn header-item  me-2">
...
<?php /**PATH C:\xampp\htdocs\zopa_delivery\resources\views\kitchen\layouts\topbar.blade.php ENDPATH**/ ?>