                        ...
                        <div class="d-flex flex-column h-100">
                            <div class="mb-4 text-center">
                                <a href="<?php echo e(url('/')); ?>" class="d-block auth-logo">
                                    <img src="<?php echo e(asset('front/images/logo_red.png')); ?>" alt="<?php echo config('app.name'); ?>" height="100">
                            ...
                            <div class="auth-content my-auto">
                                <div class="text-center">
                                    ...
                                    <p class="text-muted mt-2">Sign in to continue to ZOPAs.</p>
                                </div>
                                <form class="mt-4 pt-2" action="<?php echo e(route('kitchen.login.submit')); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.master-without-nav', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\zopa_delivery\resources\views\kitchen\auth\login.blade.php ENDPATH**/ ?>