<?php $__env->startSection('title', 'Zopa Food Drop ഉപയോഗിക്കുന്ന വിധം'); ?>
    ...
    <div class="row">
        <div class="col-md-12 p-4 lh-lg">
            ...
            <ul>
                ...
                <li><strong><?php echo e(App\Helpers\FileHelper::convertTo12Hour(Utility::CUTOFF_TIME)); ?></strong> കഴിഞ്ഞാൽ ആ ദിവസം അവധി റദ്ദാക്കാനാകില്ല.</li>
            </ul>
            ...
            <ul>
                ...
                <li><strong>Cutoff സമയം കഴിഞ്ഞു?</strong> <strong><?php echo e(App\Helpers\FileHelper::convertTo12Hour(Utility::CUTOFF_TIME)); ?></strong> കഴിഞ്ഞാൽ ഓർഡർ അല്ലെങ്കിൽ Leave മാറ്റം സാധ്യമല്ല.</li>
            </ul>
            ...
            <ul>
                ...
                <li>Leave-കൾ <strong><?php echo e(App\Helpers\FileHelper::convertTo12Hour(Utility::CUTOFF_TIME)); ?></strong> -ന് മുമ്പ് അപേക്ഷിക്കുക.</li>
            </ul>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\zopa_delivery\resources\views\pages\how_to_use_ml.blade.php ENDPATH**/ ?>