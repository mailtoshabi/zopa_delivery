...
<div class="row">
    <form method="POST" action="<?php echo e(isset($customer)? route('kitchen.customers.update',encrypt($customer->id)) : route('kitchen.customers.store')); ?>" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="mb-3 required">
                                ...
                                <input type="hidden" id="kitchen_id" name="kitchen_id" value="<?php echo e(encrypt(auth('kitchen')->id())); ?>" >
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-3 required">
                                ...
                                <select id="language" name="language" class="form-control select2">
                                    <option value="en" <?php echo e(isset($customer) && $customer->language === 'en' ? 'selected' : ''); ?>>English</option>
                                    <option value="ml" <?php echo e(isset($customer) &&  $customer->language === 'ml' ? 'selected' : ''); ?>>മലയാളം</option>
                                </select>
...
<script>
    ...
    function getdistrict(val,d_id) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo e(route('kitchen.list.districts')); ?>",
            data:formData,
...
<?php echo $__env->make('kitchen.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\zopa_delivery\resources\views\kitchen\customers\create.blade.php ENDPATH**/ ?>