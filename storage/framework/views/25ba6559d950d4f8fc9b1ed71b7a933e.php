<?php $__env->startSection('title'); ?> <?php echo app('translator')->get('translation.Product_List'); ?>  of <?php echo e($wallet_group->name); ?><?php $__env->stopSection(); ?>
...
<?php $__env->slot('li_2'); ?> <?php echo app('translator')->get('translation.Wallet Group_Manage'); ?> <?php $__env->endSlot(); ?>
<?php $__env->slot('title'); ?> <?php echo app('translator')->get('translation.Product_List'); ?>  of <?php echo e($wallet_group->name); ?><?php $__env->endSlot(); ?>
        ...
        <div class="card mb-0">
            <div class="card-body">
                 <div class="row align-items-center">
                     <div class="col-md-6">
                         <div class="mb-3">
                             <h5 class="card-title"><?php echo app('translator')->get('translation.Product_List'); ?> of <?php echo e($wallet_group->name); ?><span class="text-muted fw-normal ms-2">(<?php echo e($products->count()); ?>)</span></h5>
                         </div>
                     </div>
...
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\zopa_delivery\resources\views\admin\wallet_groups\products.blade.php ENDPATH**/ ?>