                        ...
                        <div class="table-responsive mb-4">
                            ...
                            <form method="GET" class="row mb-3" id="customer-filter-form" autocomplete="off">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <a href="<?php echo e(route('kitchen.customers.wallets')); ?>" class="btn btn-link">Reset</a>
                                </div>
                            </form>
                            <!-- Filter Form End -->
                            ...
                            <table class="table align-middle dt-responsive table-check nowrap" style="width: 100%;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo e($wallet->walletGroup->name); ?>- <?php echo e($wallet->quantity); ?> No(s)</td>
                                        <td>
                                            <?php echo $wallet->is_on ? '<span class="badge bg-secondary">Default</span>' : ''; ?>

                                            <?php echo $wallet->status ? '<span class="badge bg-success">Active</span>' : '<span class="badge bg-danger">Suspended</span>'; ?>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li>
                                                        <a class="dropdown-item" href="<?php echo e(route('kitchen.customers.wallets.toggleWalletStatus', encrypt($wallet->id))); ?>">
                            ...
                            <div class="pagination justify-content-center mt-3">
                                <?php echo e($wallets->appends(request()->query())->links()); ?>
...
document.getElementById('bulk-status-toggle').addEventListener('click', function () {
    ...
    fetch("<?php echo e(route('kitchen.customers.wallets.bulkToggle')); ?>", {
        method: 'POST',
        headers: {
...
<?php echo $__env->make('kitchen.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\zopa_delivery\resources\views\kitchen\wallets\index.blade.php ENDPATH**/ ?>