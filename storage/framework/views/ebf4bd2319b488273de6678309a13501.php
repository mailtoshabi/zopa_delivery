...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-sm-12 required">
                            ...
                            <div class="input-group mb-2">
                                ...
                                <gmpx-placeautocomplete id="autocomplete" input="autocomplete-input"></gmpx-placeautocomplete>
                                <input type="text" id="autocomplete-input" placeholder="Enter location" class="form-control" value="<?php echo e(isset($kitchen)?$kitchen->location_name:old('location_name')); ?>">
                                <button
                                    type="button"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-sm-6 mb-3">
                                ...
                                <span id="license_fileImageDiv" <?php if(isset($kitchen)&&empty($kitchen->license_file)): ?> style="display: none" <?php endif; ?>>
                                    ...
                                    <a href="<?php echo e(Storage::url(App\Models\Kitchen::DIR_PUBLIC_LICESNSE . '/' . $kitchen->license_file)); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-sm-6 mb-3">
                                ...
                                <span id="fssai_certificateImageDiv" <?php if(isset($kitchen)&&empty($kitchen->fssai_certificate)): ?> style="display: none" <?php endif; ?>>
                                    ...
                                    <a href="<?php echo e(Storage::url(App\Models\Kitchen::DIR_PUBLIC_FSSAI . '/' . $kitchen->fssai_certificate)); ?>">
                                        <i class="fas fa-file"></i>
                                    </a>
                                        <button type="button" class="btn-close" aria-label="Close">x</button>
                                    <?php endif; ?>
                            ...
                            <div class="col-sm-12 mb-3">
                                ...
                                <span id="other_documentsImageDiv" <?php if(isset($kitchen)&&empty($kitchen->other_documents)): ?> style="display: none" <?php endif; ?>>
                                    ...
                                    <a href="<?php echo e(Storage::url(App\Models\Kitchen::DIR_PUBLIC_OTHDOC . '/' . $kitchen->other_documents)); ?>">
                                        <i class="fas fa-file"></i>
                                    </a>
                                        <button type="button" class="btn-close" aria-label="Close">x</button>
                                    <?php endif; ?>
                                ...
                                <span id="other_documentsInputDiv" <?php if(isset($kitchen)&&!empty($kitchen->other_documents)): ?> style="display: none" <?php endif; ?>>
                                    <input id="other_documents" name="other_documents" type="file" class="form-control"  placeholder="File">
                                    <?php if(isset($kitchen)&&!empty($kitchen->other_documents)): ?>
                                        <button type="button" class="btn-close" aria-label="Close">x</button>
                                    <?php endif; ?>
                                </span>
...
<!-- Maps JavaScript API with places_impl library -->
    <script
      src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBlsEVjPfChYExnraJoKmt7aG7ItrPZ9TA&callback=initMap"
      async
      defer>
    </script>
    <script
    type="module"
    src="https://maps.googleapis.com/maps/api/js/webcomponents/loader.js">
    </script>
    ...
    <script>
      ...
      function setupAutocomplete() {
        ...
        autocompleteElement.addEventListener('gmpx-placeautocomplete:place', (event) => {
          ...
          document.getElementById('location_name').value = place.formattedAddress;
...
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\zopa_delivery\resources\views\admin\kitchens\create_copy.blade.php ENDPATH**/ ?>