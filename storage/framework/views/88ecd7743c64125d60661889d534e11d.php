            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <?php if($user->hasRole(['Administrator', 'Manager'])): ?>
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="<?php echo e(route('admin.daily_meals.index')); ?>">Today's Meals</a></li>
                            <li><a href="<?php echo e(route('admin.daily_meals.extra')); ?>">Extra Meals</a></li>
                            <li><a href="<?php echo e(route('admin.daily_meals.previous')); ?>">Archived Meals</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="<?php echo e(route('admin.customers.wallets')); ?>">Meals Wallet</a></li>
                            <li><a href="<?php echo e(route('admin.customers.addon.wallets')); ?>">Addon Wallet</a></li>
                            <li><a href="<?php echo e(route('admin.wallet_groups.index')); ?>"><?php echo app('translator')->get('translation.Wallet_Group_Manage'); ?></a></li>
                        </ul>
                    </li>
                    ...
                    <li class="<?php echo e(set_active(['admin.mess_categories.edit', 'admin.mess_categories.create'])); ?>">
                        <a href="<?php echo e(route('admin.mess_categories.index')); ?>">
                            <i class="fas fa-coins"></i>
                            <span data-key="t-email"><?php echo app('translator')->get('translation.MessCategory_Manage'); ?></span>
                        </a>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="<?php echo e(route('admin.meals.create')); ?>"><?php echo app('translator')->get('translation.Add_Menu'); ?></a></li>
                            <li class="<?php echo e(set_active('admin.meals.edit')); ?>">
                                <a href="<?php echo e(route('admin.meals.index')); ?>"><?php echo app('translator')->get('translation.List_Menu'); ?></a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="<?php echo e(route('admin.addons.create')); ?>"><?php echo app('translator')->get('translation.Add_Menu'); ?></a></li>
                            <li class="<?php echo e(set_active('admin.addons.edit')); ?>">
                                <a href="<?php echo e(route('admin.addons.index')); ?>"><?php echo app('translator')->get('translation.List_Menu'); ?></a>
                            </li>
                        </ul>
                    </li>
                <?php endif; ?>
                ...
                <?php if($user->hasRole(['Administrator', 'Manager'])): ?>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            <li class="<?php echo e(set_active(['admin.customers.edit', 'admin.customers.view'])); ?>">
                                <a href="<?php echo e(route('admin.customers.index')); ?>"><?php echo app('translator')->get('translation.List_Menu'); ?></a>
                            </li>
                            <li><a href="<?php echo e(route('admin.customers.create')); ?>"><?php echo app('translator')->get('translation.Add_Menu'); ?></a></li>
                        </ul>
                    </li>
                <?php endif; ?>
                ...
                <?php if($user->hasRole('Administrator')): ?>
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            <li class="<?php echo e(set_active('admin.users.edit')); ?>">
                                <a href="<?php echo e(route('admin.users.index')); ?>"><?php echo app('translator')->get('translation.List_Menu'); ?></a>
                            </li>
                            <li><a href="<?php echo e(route('admin.users.create')); ?>"><?php echo app('translator')->get('translation.Add_Menu'); ?></a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            <li class="<?php echo e(set_active('admin.kitchens.edit')); ?>">
                                <a href="<?php echo e(route('admin.kitchens.index')); ?>"><?php echo app('translator')->get('translation.List_Menu'); ?></a>
                            </li>
                            <li><a href="<?php echo e(route('admin.kitchens.create')); ?>"><?php echo app('translator')->get('translation.Add_Menu'); ?></a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="<?php echo e(route('admin.settings.index')); ?>"><?php echo app('translator')->get('translation.General_Settings'); ?></a></li>
