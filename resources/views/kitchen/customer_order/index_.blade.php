...
<div class="row">
    ...
    <ul class="nav nav-tabs">
        <li class="nav-item">
          <a class="nav-link @if($is_active==Utility::ITEM_ACTIVE) active @endif" @if($is_active==Utility::ITEM_ACTIVE)aria-current="page"@endif href="{{ route('kitchen.orders.index','status='.encrypt(Utility::ITEM_ACTIVE)) }}">All</a>
        </li>
        <li class="nav-item">
          <a class="nav-link @if($is_active==Utility::ITEM_INACTIVE) active @endif" @if($is_active==Utility::ITEM_INACTIVE)aria-current="page"@endif href="{{ route('kitchen.orders.index','status='.encrypt(Utility::ITEM_INACTIVE)) }}">Pending <span class="badge rounded-pill bg-soft-danger text-danger float-end">{{ $count_new }}</span></a>
        </li>
        <li class="nav-item">
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-end">
                                                            @if($customer_order->status == Utility::ITEM_INACTIVE)
                                                                <li>
                                                                <a onclick="return confirm('Are you sure to Activate & Mark as Paid?')" class="dropdown-item" href="{{ route('kitchen.orders.activate',encrypt($customer_order->id))}}">
