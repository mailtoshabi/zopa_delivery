...
@section('title') @lang('translation.Product_List')  of {{ $wallet_group->name }}@endsection
@section('css')
...
@slot('li_2') @lang('translation.Wallet Group_Manage') @endslot
@slot('title') @lang('translation.Product_List')  of {{ $wallet_group->name }}@endslot
@endcomponent
        ...
        <div class="card mb-0">
            <div class="card-body">
                 <div class="row align-items-center">
                     <div class="col-md-6">
                         <div class="mb-3">
                             <h5 class="card-title">@lang('translation.Product_List') of {{ $wallet_group->name }}<span class="text-muted fw-normal ms-2">({{ $products->count() }})</span></h5>
                         </div>
                     </div>
