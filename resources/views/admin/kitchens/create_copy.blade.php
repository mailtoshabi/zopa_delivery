                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 required">
                            ...
                            <div class="input-group mb-2">
                                ...
                                <input type="text" id="autocomplete-input" placeholder="Enter location" class="form-control" value="{{ isset($kitchen)?$kitchen->location_name:old('location_name')}}">
                                <button
                                    type="button"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 mb-3">
                                ...
                                <span id="license_fileImageDiv" @if(isset($kitchen)&&empty($kitchen->license_file)) style="display: none" @endif>
                                    ...
                                    <a href="{{ Storage::url(App\Models\Kitchen::DIR_PUBLIC_LICESNSE . '/' . $kitchen->license_file) }}">
                            ...
                            <div class="col-sm-6 mb-3">
                                ...
                                <span id="fssai_certificateImageDiv" @if(isset($kitchen)&&empty($kitchen->fssai_certificate)) style="display: none" @endif>
                                    ...
                                    <a href="{{ Storage::url(App\Models\Kitchen::DIR_PUBLIC_FSSAI . '/' . $kitchen->fssai_certificate) }}">
                                        <i class="fas fa-file"></i>
                                    </a>
                                        <button type="button" class="btn-close" aria-label="Close">x</button>
                                    @endif
                            ...
                            <div class="col-sm-12 mb-3">
                                ...
                                <span id="other_documentsImageDiv" @if(isset($kitchen)&&empty($kitchen->other_documents)) style="display: none" @endif>
                                    ...
                                    <a href="{{ Storage::url(App\Models\Kitchen::DIR_PUBLIC_OTHDOC . '/' . $kitchen->other_documents) }}">
                                        <i class="fas fa-file"></i>
                                    </a>
                                        <button type="button" class="btn-close" aria-label="Close">x</button>
                                    @endif
