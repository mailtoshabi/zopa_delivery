...
@section('title', 'സൈറ്റ് മാപ്പ് - ' . config('app.name'))
            ...
            <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item">
                    ...
                    <ul>
                        ...
                        <li><strong>പരമാവധി ദിവസം:</strong> {{ Utility::MAX_LEAVE_DAYS_AHEAD }} ദിവസം മുന്നേ വരെ.</li>
                        <li><strong>കട്ട്ഓഫ് സമയം:</strong> മാറ്റങ്ങൾ അനുവദിക്കപ്പെടുന്നത് {{ $lastOrderTime }} വരെ മാത്രം.</li>
                    </ul>
                </li>
                ...
                <li class="list-group-item">
                    ...
                    <ul>
                        <li><a href="{{ route('how_to_use') }}">ഉപയോഗിക്കുന്ന വിധം</a></li>
                        <li><a href="{{ route('site_map') }}">സപ്പോർട്ട്</a></li>
                        <li><a href="{{ route('support') }}">സൈറ്റ് മാപ്പ്</a></li>
                    </ul>
                </li>
