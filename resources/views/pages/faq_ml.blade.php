...
@section('title', 'പതിവുചോദ്യങ്ങൾ - ' . config('app.name'))
...
<div class="container mt-5">
    ...
    <p class="text-center text-muted mt-3"> @appName സംബന്ധിച്ച പതിവായ ചോദ്യങ്ങൾക്ക് ഇവിടെ ഉത്തരം കണ്ടെത്താം</p>
        ...
        <div class="accordion-item">
            ...
            <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#faqAccordion">
                <div class="accordion-body">
                    @appName ഒരു വീട്ടിൽ പാചകം ചെയ്ത ഭക്ഷണം വീട്ടിലേയ്ക്ക് തന്നെ എത്തിക്കുന്ന സേവനമാണ്. ഞങ്ങൾ ശുചിത്വമുള്ള അടുക്കളകളിൽ പ്രാദേശികമായി ലഭ്യമാക്കുന്ന പച്ചവസ്തുക്കുകൾ ഉപയോഗിച്ച് പാകം ചെയ്യുന്നു.
                </div>
            </div>
        </div>
